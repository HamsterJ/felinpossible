...
function callAjax(a,b,d,f){if(!ancreExpr.test(a)){var b=b||"corps",c=$("#"+(d||"chargementCorps")),e=$("#"+b);$.ajax({type:f?"POST":"GET",data:$("#"+f).serialize(),url:removeHash(a),beforeSend:function(){scrollToContent();e.hide();c.fadeIn("medium")},success:function(a){deleteWidgets(b);e.html(a);try{dojo.parser.parse(b)}catch(c){}},error:function(a,b,c){console.error("HTTP status code: ",a.status,"Message: ",c);e.html(a.responseText)},complete:function(){resizeIframe();c.hide();e.fadeIn("medium")}})}}
...
function resizeIframe(){var a=document.getElementById("framePerdusTrouves");if(a){var b=document.documentElement.clientHeight,b=b-a.offsetTop;a.style.height=b-20+"px"}}function popoverAction(a,b){var d=$("#"+a),f=d.parent().find(".popover:first").hasClass("in");$("[rel=popover]").popover("destroy");f||$.ajax({type:"GET",url:b,cache:!0,dataType:"html",success:function(a){d.attr("data-content",a);d.popover("show")}})}function popoverClose(a){$("#"+a).popover("destroy")};