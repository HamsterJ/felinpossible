...
$manual_db=isset($_POST['manual_db']) ? trim($_POST['manual_db']):'';
$connection='';
$delfiles=Array();
...
switch ($phase) {
	...
	if(file_exists("config.php") && file_exists($config['paths']['config']."mysqldumper.php"))zipConfig();
	...
	$check_dirs=ARRAY("work/","work/config/","work/log/","work/backup/","work/structure/");
	$msg='';
