...
function new_file($last_groesse=0)
{
	...
	if ($dump['part']-$dump['part_offset']==1)
	{
		...
		$dump['structure'].=$mysql_commentstring.' Dump created: '.$cur_time.$nl.$mysql_commentstring.' This file only contains the structure of the database without data \n\n';
...
function get_content($db, $table)
{
	...
	if($table_ready==1) $dump['data'].="/*!40000 ALTER TABLE `$table` ENABLE KEYS */;\n";
