...
function MSD_mysql_connect($encoding='utf8',$keycheck_off=false)
{
	...
	{
//echo "<br>Standard encoding des Servers: ".$config['mysql_standard_character_set'];
//echo "<br>Gewünschte Verbindungskodierung: ".$encoding;
