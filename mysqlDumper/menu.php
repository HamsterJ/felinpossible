...
if(isset($_POST['selected_config']) || isset($_GET['config']))
{
	...
	if (is_readable($config['paths']['config'].$new_config.'.php'))
	{
		...
		if (read_config($new_config))
		{
			...
			parent.MySQL_Dumper_content.location.href=\'config_overview.php?config='.urlencode($new_config).
			'&sel=\'+selected_div</script>';
		}
...
<a href="http://www.mysqldumper.de/" target="_blank">
    <img src="css/<?php echo $config['theme'];?>/pics/h1_logo.gif" alt="MySQL Dumper - Homepage">
</a>
<div id="menu">
    <?php
    echo PicCache();
    ?>
    <p class="version">Version <?php echo MSD_VERSION.'&nbsp;'.MSD_VERSION_ADD; ?></p>
    <ul>
        <li id="m1" class="active">
            <a href="main.php" target="MySQL_Dumper_content" onclick="setMenuActive('m1')"><?php echo $lang['home']; ?> </a>
        </li>
        <li id="m2" class="">
            <a href="config_overview.php" target="MySQL_Dumper_content" onclick="setMenuActive('m2')"><?php echo $lang['config']; ?> </a>
        </li>
        <?php
        ...
        ?>
        <li id="m3" class="">
            <a href="filemanagement.php?action=dump" target="MySQL_Dumper_content" onclick="setMenuActive('m3')"><?php echo $lang['dump']; ?> </a>
        </li>
        <li id="m4" class="">
            <a href="filemanagement.php?action=restore" target="MySQL_Dumper_content" onclick="setMenuActive('m4')"><?php echo $lang['restore']; ?> </a>
        </li>
        <li id="m5" class="">
            <a href="filemanagement.php?action=files" target="MySQL_Dumper_content" onclick="setMenuActive('m5')"><?php echo $lang['file_manage']; ?> </a>
        </li>
        <li id="m6" class="">
            <a href="sql.php?db=<?php echo $databases['db_actual']; ?>&amp;dbid=<?php echo $databases['db_selected_index']; ?>" target="MySQL_Dumper_content" onclick="setMenuActive('m6')"><?php echo $lang['sql_browser']; ?> </a>
        </li>
        <li id="m7" class="">
            <a href="log.php" target="MySQL_Dumper_content" onclick="setMenuActive('m7')"><?php echo $lang['log']; ?> </a>
        </li>
        <?php } ?>
        <li id="m8" class="">
            <a href="<?php echo "language/".$config['language']; ?>/help.php" target="MySQL_Dumper_content" onclick="setMenuActive('m8')"><?php echo $lang['credits']; ?> </a>
        </li>
    </ul>
</div>
<div id="selectConfig">
    <form action="menu.php" method="post">
        <fieldset id="configSelect">
        	...
        	<select name="selected_config" style="width:157px;" onchange="this.form.submit()">
        		<?php echo get_config_filelist(); ?>
        	</select>
	    </fieldset>
	</form>
    <form action="menu.php" method="post">
        <fieldset id="dbSelect">
	        <legend><?php echo $lang['choose_db'];?>:</legend>
<?php
	if (isset($databases['Name']) && count($databases['Name'])>0)
	{
...
?>
        <p><a href="menu.php?action=dbrefresh"><?php echo $lang['load_database'] ?></a></p>
    </fieldset>
    </form>
...
else echo '<script language="javascript" type="text/javascript">setactiveMenuFromContent();</script>';
?>
</body>
</html>
<?php ob_end_flush(); ?>