...
//Status Logfiles
echo '<div align="left"><table class="bdr"><tr><td><table><tr><td valign="top"><strong>'.$lang['logfileformat'].'</strong><br><br>'.(($config['logcompression']==1) ? '<img src="'.$config['files']['iconpath'].'gz.gif" width="32" height="32" alt="compressed" align="left">' : '<img src="'.$config['files']['iconpath'].'blank.gif" width="32" height="32" alt="" align="left">');
...
echo '</tr><tr><td colspan="3" align="center"><a class="small" href="log.php?r='.$r.'&amp;revers=0">'.$lang['noreverse'].'</a>&nbsp;&nbsp;&nbsp;<a class="small" href="log.php?r='.$r.'&amp;revers=1">'.$lang['reverse'].'</a></td></tr></table></td></tr></table></div>';
