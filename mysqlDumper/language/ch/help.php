...
Perlscript mit Understützig vom Detlev Richter<br>
</td></tr></table>
<br>
...
lönd eifach s Fäld läär.</li>
	...
	<li><a name="conf8"></a><strong>Automatisches Lösche vo de Backups:</strong> Wänn diä Option aktiviert isch, wärdet älteri Backups nach de folgende Regle automatisch gelöscht. Kombinatione sind mögli.</li>
	<li><a name="conf9"></a><strong>Alter vo de Dateie (in Täg):</strong> En Wert > 0 löscht alli Backupdateie, wo älter sind als diä Aagab.</li>
