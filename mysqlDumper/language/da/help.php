...
<ul>
	...
	<li><a name="conf8"></a><strong>Automatisk sletning af backups:</strong> Når du aktiverer denne indstilling, slettes backupfiler automatisk efter følgende regler. Kombinationer er mulige.</li>
	<li><a name="conf9"></a><strong>Slet ud fra filers alder (i dage):</strong> En værdi > 0 sletter alle filer ældre end værdien i dage</li>
