...
<ul><br>
	...
	<li><a name="conf8"></a><strong>Automatisk radering av backup:</strong> om denna option aktiveras så raderas äldre backup-filer automatiskt enligt följande regler. Reglerna kan kombineras.</li>
	<li><a name="conf9"></a><strong>Filens ålder (dagar):</strong> ett värde > 0 aktiverar radering av alla backup-filer som är äldre än detta värde i dagar.</li>
