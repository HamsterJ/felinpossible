...
$rcmail_config['default_host'] = 'ssl://91.121.135.81';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'tls://91.121.135.81';
...
$rcmail_config['smtp_user'] = 'felinpossible';

// SMTP password (if required) if you use %p as the password Roundcube
// will use the current user's password for login
$rcmail_config['smtp_pass'] = 'TAG_SMTP_PASSWORD';
...
$rcmail_config['des_key'] = 'TAG_ENCRYPT_KEY';
