...
//-- add
			$subforums[$parent_id][$forum_id]['colour'] = $row['forum_name_colour'];
...
//-- add
			...
			$s_subforums_list[] = '<a href="' . $subforum['link'] . '" class="subforum ' . (($subforum['unread']) ? 'unread' : 'read') . '" ' . $subforum_name_colour . '>' . $subforum['name'] . '</a>';
//-- fin mod : forum title colour ----------------------------------------------
		}
...
//-- mod : forum title colour --------------------------------------------------
//-- add
			'FORUM_NAME_COLOUR'	=> $row['forum_name_colour'],
			'S_FORUM_NAME_COLOUR'	=> !empty($row['forum_name_colour']) ? true : false,
//-- fin mod : forum title colour ----------------------------------------------			
...
//-- mod : forum title colour --------------------------------------------------
//-- add
		'FORUM_NAME_COLOUR'	=> $forum_data['forum_name_colour'],
		'S_FORUM_NAME_COLOUR'	=> !empty($forum_data['forum_name_colour']) ? true : false,
//-- fin mod : forum title colour ----------------------------------------------		
...
MOD-*/
//-- add
	$active_f_name = $active_f_id = $active_f_count = $active_f_pct = $active_f_name_colour = '';
//-- fin mod : forum title colour ----------------------------------------------
...
//-- mod : forum title colour --------------------------------------------------
//-- add
		$active_f_name_colour = $active_f_row['forum_name_colour'];
//-- fin mod : forum title colour ----------------------------------------------		
	}
...
//-- mod : forum title colour --------------------------------------------------
//-- add
		'ACTIVE_FORUM_COLOUR' => $active_f_name_colour,
		'S_ACTIVE_FORUM_COLOUR' => !empty($active_f_name_colour) ? true : false,
//-- fin mod : forum title colour ----------------------------------------------		
