...
//-- add
			$sql = str_replace(', f.forum_name', ', f.forum_name, f.forum_name_colour', $sql);
...
//-- mod : forum title colour --------------------------------------------------
//-- add
			$sql_select .= ', f.forum_name_colour';
//-- fin mod : forum title colour ----------------------------------------------
...
//-- mod : forum title colour --------------------------------------------------
//-- add
				'FORUM_TITLE_COLOUR'	=> $row['forum_name_colour'],
				'S_FORUM_TITLE_COLOUR'	=> !empty($row['forum_name_colour']) ? true : false,
//-- fin mod : forum title colour ----------------------------------------------
...
//-- mod : forum title colour --------------------------------------------------
//-- add
$sql = str_replace(', f.forum_type', ', f.forum_type, f.forum_name_colour', $sql);
//-- fin mod : forum title colour ----------------------------------------------
$result = $db->sql_query($sql);
...
MOD-*/
//-- add
		$forum_name_colour = $row['forum_name_colour'] ? 'style="color:#' . $row['forum_name_colour'] . '"' : '';
		$holding .= '<option value="' . $row['forum_id'] . '"' . $selected . ' ' . $forum_name_colour . '>' . $padding . $row['forum_name'] . '</option>';
//-- fin mod : forum title colour ----------------------------------------------
	}
	else
	{
...
MOD-*/
//-- add
		$subforum_name_colour = $row['forum_name_colour'] ? 'style="color:#' . $row['forum_name_colour'] . '"' : '';
		$s_forums .= $holding . '<option value="' . $row['forum_id'] . '"' . $selected . ' ' . $subforum_name_colour . '>' . $padding . $row['forum_name'] . '</option>';
//-- fin mod : forum title colour ----------------------------------------------
		$holding = '';
	}
}
