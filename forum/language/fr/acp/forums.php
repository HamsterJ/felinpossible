...
$lang = array_merge($lang, array(
  ...
  'COPY_PERMISSIONS_EXPLAIN'		=> 'Pour faciliter la configuration des permissions de votre nouveau forum, vous pouvez copier les permissions d’un forum déjà existant.',
	...
	'COPY_PERMISSIONS_EDIT_EXPLAIN'	=> 'Si vous copiez les permissions, le forum détiendra les mêmes permissions que celles que vous avez sélectionnées ici. Cela écrasera toutes les permissions antérieures du forum. Si aucun forum n’est sélectionné, les permissions actuelles seront conservées.',
