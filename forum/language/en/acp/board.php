...
//-- add
	'ALLOW_PURGE_CACHE'			=> 'Allow to purge the cache from any page',
	'ALLOW_PURGE_CACHE_EXPLAIN'	=> 'Add in the footer a button to purge the forum�s cache <strong>without confirmation</strong> from any page. You can also define the minimum permission�s level to use this feature.',
